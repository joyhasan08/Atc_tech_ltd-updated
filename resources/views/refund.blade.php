...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <!-- Refund Policy Starts Starts -->
   <section class=" p-4 py-14 max-w-6xl mx-auto text-justify tracking-tighter leading-relaxed">
            <h1 class="text-lg font-bold underline underline-offset-8 pb-2">Refund Policy</h1>
            <p>Our company strives to ensure customer satisfaction with the services we offer from Bangladesh to the
                USA. In the event that you are not entirely satisfied with the service you have received, we offer the
                following refund policy:</p>

            <h2 class="font-bold  pt-6 pb-1">1. Eligibility</h2>
            <ul>
                <li>Refunds may be considered in the following circumstances:</li>
            ...
            <h2 class="font-bold  pt-6 pb-1">2. Refund Process</h2>
            <ul class="list-disc pl-8">
                <li>To request a refund, you must contact our customer service team within the specified timeframe,
                    providing relevant details and documentation to support your refund claim.</li>
                <li>Our team will review your request and may require additional information to process the refund.</li>
            </ul>

            <h2 class="font-bold  pt-6 pb-1">3. Refund Methods</h2>
            <ul class="list-disc pl-8">
                <li>Approved refunds will be processed using the original method of payment, unless otherwise agreed
                    upon by both parties.</li>
                <li>Refund processing times may vary and are subject to the policies of the payment service provider.
                </li>
            </ul>

            <h2 class="font-bold  pt-6 pb-1">4. Non-Refundable Items</h2>
            <p>Certain services may be non-refundable, such as fees for consultation, personalized services, or services
                that have been fully rendered as per the original agreement.</p>

            <h2 class="font-bold  pt-6 pb-1">5. Cancellation Policy</h2>
            <ul class="list-disc pl-8">
                <li>Specific services may have their own cancellation policy, which will be communicated at the time of
                    booking or purchase.</li>
                <li>Cancellation charges or penalties may apply in accordance with the terms and conditions of the
                    specific service.</li>
            </ul>

            <h2 class="font-bold  pt-6 pb-1">6. Contact Us</h2>
            <p>If you have any questions about our refund policy or would like to request a refund, please contact our
                customer service team. We are here to assist you and address any concerns you may have.</p>
                <br>

            <p>Our refund policy is designed to be fair and transparent, ensuring that our customers are provided with
                appropriate recourse in the event of service-related issues.</p>
        </section>
        <!-- Refund Policy Starts Starts -->
