            ...
            <footer class="py-6 bg-[#3a3a3a] text-white">
                <div class="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-400 md:space-y-12 divide-opacity-50">
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 text-center md:text-left md:col-span-3">
                            <p class="pb-1 text-lg font-medium">Bangladesh Office</p>
                            <ul>
                                <li>
                                    <p class="hover:text-blue-700">Email: support@atctechltd.com</p>
                                </li>
                        ...
                        <div class="col-span-12 text-center md:text-left md:col-span-3">
                            <p class="pb-1 text-lg font-medium">USA Office</p>
                            <ul>
                                <li>
                                    <p class="hover:text-blue-700">404, Shatto Pl, Suite # 506, <br>
                                        Losangeles, CA 90020.
                                    </p>
                                </li>
                                <li>
                    ...
                    <div class="grid justify-center pt-6 lg:justify-between">
                        ...
                        <div class="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                            <a rel="noopener noreferrer" href="https://www.linkedin.com/company/atc-tech-ltd17/"
                                title="LinkedIn"
                            ...
                            <a rel="noopener noreferrer" href="https://www.youtube.com/@ATCTechLtd17" title="Youtube"
                            ...
                            <a rel="noopener noreferrer" href="https://www.facebook.com/ATCTechLtd17/" title="Facebook"
                                class="flex items-center justify-center w-10 h-10 rounded-full sm:w-10 sm:h-10 bg-[#0F79B9] dark:text-gray-900">
                            ...
                            <a rel="noopener noreferrer" href="https://twitter.com/atctechltd17" title="X"
