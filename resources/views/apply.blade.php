...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <main>
            ...
            <div class="w-full md:w-96 md:max-w-full mx-auto py-10 px-4">
                ...
                <div class="p-6 border border-gray-300 sm:rounded-md">
                    <form>
                        ...
                        <label class="block mb-6">
                            <span class="text-gray-700">Upload your Picture</span>
                        ...
                        <label class="block mb-6">
                            <span class="text-gray-700">Upload your Resume</span>
                            <input required name="cv" type="file"
                                class=" block  w-full mt-1 focus:border-indigo-300 focus:ring focus:ring-indigo-200  focus:ring-opacity-50 " />
                        </label>
                        ...
                        <div class="mb-6">
                            <button type="submit"
                                class=" h-10 px-5 text-indigo-100 bg-[#0f79b9] rounded-lg transition-colors duration-150  focus:shadow-outline  hover:bg-indigo-800 ">
                                Send
                            </button>
                        </div>
