...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <main>
            ...
            <h1 class="text-lg font-bold underline underline-offset-8 pb-2">About ATC Tech Limited</h1>
            <p>
              ATC Tech Limited is an online destination committed to providing
              high-quality own products and an exceptional marketing experience for
              our customers. Established in 2017, we have been dedicated to offering a
              wide range of dedicated software to meet various needs and preferences.
            </p>
      
            <h2 class="font-bold  pt-6 pb-1">Our Mission</h2>
            <p>
              To provide state-of-the-art IT solutions with effective support services
              to business houses at home and abroad in this fast-changing world of
              economy. ATC Tech Ltd mission includes:
            </p>
            <ul class="list-disc pl-8">
              ...
              <li>
                Providing high-quality software development services, professional
                consulting, and development outsourcing that would improve our
                customers’ operations.
              </li>
              <li>Providing our customers with Value for Money.</li>
              <li>
                Providing our employees with meaningful work and advancement
                opportunities.
              </li>
            </ul>
      
            <h2 class="font-bold  pt-6 pb-1">Vision Statement</h2>
            <p>
              Embracing innovation, we strive to be a global leader in technology
              solutions, empowering businesses to thrive. We envision a future where
              seamless communication and data security fuel progress, while our team
              thrives in a culture of growth and impact.
              <a href="http://www.atctechltd.com" target="_blank"
                >www.atctechltd.com</a
              >
            </p>
      
            <h2 class="font-bold  pt-6 pb-1">Goal Statement</h2>
            <p>
              To be among the top 10 companies in the existing industry by 2030, and
              to do any and everything within our best efforts that are necessary to
              achieve this. Through state-of-the-art IT services and software
              development, we partner with clients across industries. We optimize
              workflows, enhance security, and deliver reliable support, ensuring
              success and value for all. We believe in fostering meaningful work,
              empowering both clients and our dedicated team.
            </p>
      
            <h2 class="font-bold  pt-6 pb-1">What We Offer</h2>
            <p>
              We specialize in offering a diverse selection of dedicated software,
              carefully curated to ensure quality, style, and functionality. Our
              product range includes online-based ERP, NGO, Petrol Pump, e-Management,
              and on-demand queries. Each item is selected with attention to detail
              and designed to meet the evolving needs of our customers.
            </p>
      
            <h2 class="font-bold  pt-6 pb-1">Why Choose Us</h2>
            <p class="pb-2">
              ATC Tech Limited continues to operate with higher client expectancy and
              flexible solution offers. The Company is a pioneer in Interactive
              Virtual Teams (IVT) which enables the client and the service provider to
              establish successful communication channels and support to various
              clients and near-shoring business models, thus keeping the deadlines on
              time and on track.
            </p>
            <p class="">
              ATC Tech Ltd differentiation point comes with three simple principles:
            </p>
            <ul class="list-disc pl-8">
              <li>True collaboration with customers and partners.</li>
              <li>Complete understanding of customers' business.</li>
              <li>Persistence in finishing the job whatever it takes.</li>
            </ul>
      
            <h2 class="font-bold  pt-6 pb-1">Our Commitment</h2>
            <p>
              We are committed to fostering lasting relationships with our customers
              by delivering excellence in product quality, service, and reliability.
              ATC Tech Limited strives to evolve continually, exploring new trends,
              and expanding our product range to meet your ever-changing needs.
            </p>
      
            <h2 class="font-bold  pt-6 pb-1">Connect with Us</h2>
            <p>
              Follow us on social media platforms
              <a
                href="https://www.linkedin.com/company/atc-tech-ltd17/"
                target="_blank"
                ><span class="font-bold text-blue-500">LinkedIn</span></a
              >,
              <a href="https://www.facebook.com/ATCTechLtd17/" target="_blank"
                > <span class="font-bold text-blue-500">Facebook</span></a
              >
              to stay updated on our latest products, promotions, and exciting offers.
              Feel free to contact us at
              <a href="mailto:atctechltdbd@gmail.com"><span class=" text-blue-500">atctechltdbd@gmail.com</span></a> for
              any inquiries or assistance.
            </p>
            <p class="pt-2">
              Thank you for choosing ATC Tech Limited. We appreciate your trust and
              support in our journey to provide you with exceptional products and
              services.
            </p>
      
            <!-- <div class="footer">
              &copy; 2024 ATC Tech Limited. All rights reserved.
            </div> -->
          </section>
